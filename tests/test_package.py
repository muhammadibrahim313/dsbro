...
def test_about_returns_project_metadata(capsys):
    ...
    assert "dsbro 0.2.1" in captured.out
    assert "Homepage (GitHub): https://github.com/muhammadibrahim313/dsbro" in captured.out
    assert "Website: https://ibrahimqasmi.com" in captured.out
